...
Dashboard premium per la gestione centralizzata delle scadenze personali, familiari e professionali.
...
## Deploy (Vercel)
Framework rilevato automaticamente: **Vite**. Build command `vite build`, output `dist`.
>>>>>>> fc4cb66790bfe45d480ccd2783a40d98a969b81f
