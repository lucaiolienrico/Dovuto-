...
export const PLAN_COLORS = {
  ...
  personal:  { bg: 'bg-indigo-100', text: 'text-indigo-700', label: 'Personal' },
  famiglia:  { bg: 'bg-emerald-100',text: 'text-emerald-700',label: 'Famiglia' },
  pro:       { bg: 'bg-violet-100', text: 'text-violet-700', label: 'Pro'      },
}

export const STATUS_COLORS = {
  active:   { bg: 'bg-emerald-100', text: 'text-emerald-700', dot: 'bg-emerald-500', label: 'Attivo'     },
  trial:    { bg: 'bg-amber-100',   text: 'text-amber-700',   dot: 'bg-amber-400',   label: 'Trial'      },
  past_due: { bg: 'bg-rose-100',    text: 'text-rose-700',    dot: 'bg-rose-500',    label: 'Pagamento'  },
  churned:  { bg: 'bg-slate-100',   text: 'text-slate-500',   dot: 'bg-slate-400',   label: 'Churned'    },
}
