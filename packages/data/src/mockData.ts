import type {
  Category, Deadline, MonthlyData, Plan,
  StatusConfig, ColorKey
} from './types'
...
export const PLANS: Plan[] = [
  {
    id: 'free', name: 'Free', price: 0, annual: 0,
    desc: 'Per iniziare senza rischi', color: 'slate',
  ...
  {
    id: 'personal', name: 'Personal', price: 3.9, annual: 29,
    desc: 'Per professionisti e autonomi', color: 'indigo',
    badge: 'Più scelto', cta: 'Attiva Personal', ctaStyle: 'primary',
    features: [
  ...
  {
    id: 'famiglia', name: 'Famiglia', price: 6.9, annual: 49,
    desc: 'Per nuclei familiari complessi', color: 'emerald',
    cta: 'Attiva Famiglia', ctaStyle: 'emerald',
    features: [
      { text: 'Scadenze illimitate',    ok: true  },
      { text: 'Tutte le categorie',     ok: true  },
      { text: 'Notifiche email + push', ok: true  },
  ...
  {
    id: 'pro', name: 'Pro', price: 12.9, annual: 89,
    desc: 'Per chi non lascia nulla al caso', color: 'violet',
    cta: 'Attiva Pro', ctaStyle: 'violet',
    features: [
      { text: 'Scadenze illimitate',    ok: true },
      { text: 'Tutte le categorie',     ok: true },
      { text: 'Notifiche email + push', ok: true },
...
export const CAT_COLORS: Record<ColorKey, { bg: string; text: string; light: string }> = {
